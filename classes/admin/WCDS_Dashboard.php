...
class WCDS_Dashboard
{
	...
	public function add_presale_metabox()
	{
		...
		if($can_display/* current_user_can('manage_woocommerce') */)
		{
			...
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-avarage-estimation', __('Estimations', 'woocommerce-dashboard-stats'), array( &$this, 'render_avarage_and_estimation_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-geographic', __('Geographical', 'woocommerce-dashboard-stats'), array( &$this, 'render_geographic_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-customers', __('Customers', 'woocommerce-dashboard-stats'), array( &$this, 'render_customers_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-products', __('Products', 'woocommerce-dashboard-stats'), array( &$this, 'render_products_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-earnings', __('Sales', 'woocommerce-dashboard-stats'), array( &$this, 'render_earnings_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-refund', __('Refunds', 'woocommerce-dashboard-stats'), array( &$this, 'render_refund_metabox' ));
			wp_add_dashboard_widget( 'wcds-woocommerce-dashboard-related', __('Payments', 'woocommerce-dashboard-stats'), array( &$this, 'render_payment_methods_metabox' ));
		}
	}
