...
//echo $from_ts;echo "|";echo $to_ts;
    ...
    $entries = $wpdb->get_results( "SELECT  id,isunique,knp_date,knp_ts,knp_time FROM {$wpdb->prefix}wpdwid WHERE knp_ts >= '" . $from_ts . "' AND  knp_ts <= '" . $to_ts . "' ORDER BY id DESC");
...
<script type="text/javascript">
        ...
        var option = {
                ...
                // Add legend
                legend: {
                    data: ['<?php echo __("Unique","wpdlang"); ?>','<?php echo __("Total","wpdlang"); ?>']
                },
                toolbox: {
                  orient: 'vertical',
                    show : true,
                ...
                series: [
                    {
                        name: '<?php echo __("Unique","wpdlang"); ?>',
                        type: 'bar',
                        smooth: true,
                        symbol:'none',
                        symbolSize:2,
                    ...
                    {
                        name: '<?php echo __("Total","wpdlang"); ?>',
                        type: 'bar',
                        smooth: true,
                        symbol:'none',
                        symbolSize:2,
