...
<?php
    ...
    $entries = $wpdb->get_results( "SELECT  id,browser,knp_date FROM {$wpdb->prefix}wpdwid WHERE knp_ts >= '" . $from_ts . "' AND  knp_ts <= '" . $to_ts . "' ORDER BY id DESC");
...
<?php if(sizeof($browser_stats) > 0){ ?>
      <div class="chartBox">
        <h4 class='widhead'><?php _e('Browsers used in last', 'wpdlang');  echo $days; _e('days', 'wpdlang'); ?></h4>
...
<?php if(sizeof($series_data) > 0){ ?>
      <div class="chartBox"><div class='widspacer10'></div>
          <h4 class='widhead'><?php _e('Browsers Used By Date', 'wpdlang'); ?></h4>
    ...
    options : [
        {
            ...
            legend: {
                ...
                orient:'vertical',
                padding: 0,
                data:['<?php echo __("Chrome","wpdlang"); ?>','<?php echo __("Firefox","wpdlang"); ?>','<?php echo __("Safari","wpdlang"); ?>','<?php echo __("Opera","wpdlang"); ?>','<?php echo __("Internet-Explorer","wpdlang"); ?>','<?php echo __("Others","wpdlang"); ?>']
            },
            toolbox: {
                show : true,
                color : ['#bdbdbd','#bdbdbd','#bdbdbd','#bdbdbd'],
