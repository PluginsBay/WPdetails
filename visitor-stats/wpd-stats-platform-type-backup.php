...
<?php
    ...
    echo $from_ts." - ";
    echo $to_ts."<br>";
    echo "SELECT * FROM {$wpdb->prefix}wpdwid WHERE knp_ts >= '" . $from_ts . "' AND  knp_ts <= '" . $to_ts . "' ORDER BY id DESC";
    */

/*
$result = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}wpdwid");
...
foreach( $result as $entry ) {
    ...
    echo $ts;
           ...
           // $wpdb->query("UPDATE {$wpdb->prefix}wpdwid SET knp_ts='$ts' WHERE id='$id'");
    ...
    $entries = $wpdb->get_results( "SELECT  id,platform FROM {$wpdb->prefix}wpdwid WHERE knp_ts >= '" . $from_ts . "' AND  knp_ts <= '" . $to_ts . "' ORDER BY id DESC");
