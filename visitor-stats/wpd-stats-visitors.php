...
<div class="wp-settings-pro">
    ...
    <div class="option-title"><strong><?php echo __("Recent Visitors","wpdlang"); ?></strong>
    
    </div>
    <div class="option-descriptions"><?php echo __("List of recent visitors by time.","wpdlang"); ?>
    </div>
    
    <div class="option-input">
		<div class="wpd-wid-box">
        <div class="box-title"><?php echo __("Recent Visitor List","wpdlang"); ?>
...
$entries = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}wpdwid ORDER BY id DESC LIMIT $offset, $limit" );
...
$total = $wpdb->get_var( "SELECT COUNT(`id`) FROM {$wpdb->prefix}wpdwid" );
$num_of_pages = ceil( $total / $limit );
$page_links = paginate_links( array(
    'base' => add_query_arg( 'pagenum', '%#%' ),
    'format' => '',
    'prev_text' => __( '&laquo;', 'wpdlang' ),
    'next_text' => __( '&raquo;', 'wpdlang' ),
    'total' => $num_of_pages,
    'current' => $pagenum
) );
