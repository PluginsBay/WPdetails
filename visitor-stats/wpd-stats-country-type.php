...
<?php
    ...
    */
    ...
    $entries = $wpdb->get_results( "SELECT  id,countryName FROM {$wpdb->prefix}wpdwid WHERE knp_ts >= '" . $from_ts . "' AND  knp_ts <= '" . $to_ts . "' ORDER BY id DESC");
...
<script type="text/javascript">
        ...
        var option = {
                ...
                series: [
                    {
                        name: '<?php echo __("Visits in last","wpdlang"); ?> <?php echo $days; ?> <?php echo __("days","wpdlang"); ?>',
                        type: 'map',
                        mapType: 'world',
                        roam: true,
                        mapLocation: {
