...
wp_enqueue_script( 'user-profile' );
	...
	public function setup(){
		...
		if( current_user_can( $this->capability ) && current_user_can( 'edit_user', $current_user->ID ) ){
			...
			wp_add_dashboard_widget( 'fx_profile_dashboard_widget', __( 'Edit Profile', 'fx-profile-dashboard-widget' ), array( $this, 'dashboard_widget_callback' ), array( $this, 'dashboard_widget_control_callback' ) );
		}
	}
...
?>
		<p><strong><?php _e( 'Username:', 'fx-profile-dashboard-widget' ); ?></strong><br />
		<?php echo $current_user->user_login ?></p>

		<p><strong><?php _e( 'Full Name:', 'fx-profile-dashboard-widget' ); ?></strong><br />
...
if( function_exists( 'wp_get_current_user' ) ){
 ...
 ?>
		...
		<p><label for="fx-profile-dashboard-widget-login-name"><strong><?php _e( 'Username:', 'fx-profile-dashboard-widget' ); ?></strong></label>
